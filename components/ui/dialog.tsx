    ...
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ...
            className={cn(
                ...
                // Mobile-specific fixes to prevent horizontal scrolling/resizing
                "max-w-[calc(100vw-2rem)] overflow-hidden touch-none",
                "rounded-lg",
                className
            )}
            style={{
                // Prevent any touch gestures from moving or resizing the modal
                touchAction: 'none',
