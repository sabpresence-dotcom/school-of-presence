    ...
    return (
        <div className="relative">
            ...
            <div className="relative p-8 sm:p-10">
                ...
                {/* Toggle */}
                <div className="flex p-1 bg-slate-900/60 rounded-xl mb-8 border border-slate-700/50">
                    <button
                        ...
                        className={cn(
                            ...
                            isLogin ? "bg-white text-black shadow-lg shadow-blue-500/20" : "text-slate-400 hover:text-white"
                        )}
                    >
                        Sign In
                    </button>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        required
                                        className={`pl-10 bg-slate-900/60 border-slate-700/50 focus:border-blue-400/50 text-white placeholder:text-slate-600 h-12 rounded-xl transition-all ${
                                            error && error.includes('email') ? 'border-red-500/50 focus:border-red-500' : ''
                                        }`}
                                        autoComplete="email"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        required
                                        className={`pl-10 pr-10 bg-black/20 border-white/10 focus:border-white/50 text-white placeholder:text-slate-600 h-12 rounded-xl transition-all ${
                                            error && error.includes('password') ? 'border-red-500/50 focus:border-red-500' : ''
                                        }`}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        required
                                        className={`pl-10 bg-slate-900/60 border-slate-700/50 focus:border-blue-400/50 text-white placeholder:text-slate-600 h-12 rounded-xl transition-all ${
                                            error && error.includes('name') ? 'border-red-500/50 focus:border-red-500' : ''
                                        }`}
                                        autoComplete="name"
